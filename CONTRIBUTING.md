Contributing to RSHCoin Core
============================

The RSHCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the RSHCoin Core project, and is not to be
confused with overall RSHCoin Network Protocol consensus changes.

Whether a pull request is merged into RSHCoin Core rests with the project merge
...
Patches that change RSHCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the RSHCoin consensus, it must have been
...
The project leader is the release manager for each RSHCoin Core release.
