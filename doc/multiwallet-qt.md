...
In order to support loading of multiple wallets in rshcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is rshcoin.cpp.
...
Changes to rshcoin.cpp
----------------------
rshcoin.cpp is the entry point into rshcoin-qt, and as such, will require some minor modifications to provide hooks for
