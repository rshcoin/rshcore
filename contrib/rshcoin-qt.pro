...
RESOURCES += src/qt/rshcoin.qrc src/qt/rshcoin_locale.qrc

TRANSLATIONS += src/qt/locale/rshcoin_bg.ts \
                src/qt/locale/rshcoin_de.ts \
                src/qt/locale/rshcoin_en.ts \
                src/qt/locale/rshcoin_es.ts \
                src/qt/locale/rshcoin_fi.ts \
                src/qt/locale/rshcoin_fr.ts \
                src/qt/locale/rshcoin_it.ts \
                src/qt/locale/rshcoin_ja.ts \
                src/qt/locale/rshcoin_pl.ts \
                src/qt/locale/rshcoin_pt.ts \
                src/qt/locale/rshcoin_ru.ts \
                src/qt/locale/rshcoin_sk.ts \
                src/qt/locale/rshcoin_sv.ts \
                src/qt/locale/rshcoin_vi.ts \
                src/qt/locale/rshcoin_zh_CN.ts \
                src/qt/locale/rshcoin_zh_TW.ts
