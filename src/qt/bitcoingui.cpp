                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("RSHCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RSHCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rshcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zRSH"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About RSHCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about RSHCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for RSHCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RSHCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RSHCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a RSHCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the RSHCoin Core help message to get a list with possible RSHCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("RSHCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to RSHCoin network", "", count));
}
...
{
    QString strTitle = tr("RSHCoin Core"); // default title
...
/** Creates context menu, its actions, and rshcoins up all the relevant signals for mouse events. */
