...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("RSHCoin Core");
    QString versionText = QString(tr("Version v1.1-0.0-Core")).arg(QString::fromStdString(FormatFullVersion()));
    ...
    QString copyrightTextRSHCoin = QChar(0xA9) + QString(" 2017-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The RSHCoin Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextRSHCoin);
