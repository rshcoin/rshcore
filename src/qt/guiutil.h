...
/** Utility functions used by the RSHCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render RSHCoin addresses in monospace font
...
// Parse "rshcoin:" URI into recipient object, return true on successful parsing
