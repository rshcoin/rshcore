...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("RSHCoin Core rshcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  rshcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rshcoin transaction") + "\n" +
                               "  rshcoin-tx [options] -create [commands]   " + _("Create hex-encoded rshcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rshcoin transaction
