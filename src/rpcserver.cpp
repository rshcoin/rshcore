...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "RSHCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* RSHCoin features */
        {"rshcoin", "masternode", &masternode, true, true, false},
        {"rshcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"rshcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"rshcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"rshcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"rshcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"rshcoin", "startmasternode", &startmasternode, true, true, false},
        {"rshcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"rshcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"rshcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"rshcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"rshcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"rshcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"rshcoin", "mnbudget", &mnbudget, true, true, false},
        {"rshcoin", "preparebudget", &preparebudget, true, true, false},
        {"rshcoin", "submitbudget", &submitbudget, true, true, false},
        {"rshcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"rshcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"rshcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"rshcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"rshcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"rshcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"rshcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"rshcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"rshcoin", "mnsync", &mnsync, true, true, false},
        {"rshcoin", "spork", &spork, true, true, false},
        {"rshcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"rshcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use rshcoind, or the -server option to rshcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> rshcoin-cli " + methodname + " " + args + "\n";
}
